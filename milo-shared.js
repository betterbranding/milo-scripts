...
(function() {
  ...
  css.textContent = [
    ...
    '  color: rgba(255,255,255,0.8); padding: 4rem 2rem 2rem;',
    '  font-family: "Nunito Sans", "Gotham", sans-serif;',
    '}',
    '.milo-foot-grid {',
    ...
    '}',
    '.milo-foot-brand img { height: 50px; margin-bottom: 1rem; filter: brightness(0) invert(1); }',
    '.milo-foot-tagline { color: #288D11; font-weight: 700; margin: 0 0 0.5rem; }',
    '.milo-foot-desc { font-size: 0.9rem; line-height: 1.6; color: rgba(255,255,255,0.6); margin: 0; }',
    '.milo-foot h4 {',
    '  color: white; font-family: "League Spartan", sans-serif;',
    '  margin: 0 0 1rem; font-size: 1.1rem;',
    '}',
    '.milo-foot-links ul { list-style: none; padding: 0; margin: 0; }',
    '.milo-foot-links a {',
    '  color: rgba(255,255,255,0.7); text-decoration: none; display: block;',
    '  padding: 0.3rem 0; transition: color 0.3s;',
    '}',
    '.milo-foot-links a:hover { color: #288D11; }',
    '.milo-foot-contact p {',
    '  display: flex; align-items: center; gap: 0.5rem; margin: 0.5rem 0; font-size: 0.9rem;',
    '}',
    '.milo-foot-contact i { color: #288D11; }',
    '.milo-foot-bottom {',
