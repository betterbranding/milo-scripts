...
(function () {
  ...
  fetch(GH + '/v3/pages/home.html?v=5').then(function (r) {
...
(function () {
  ...
  fetch(GH + '/v3/pages/milex.html?v=5').then(function (r) {
    if (!r.ok) throw new Error('HTTP ' + r.status);
    return r.text();
  }).then(function (html) {
    html = html.replace('__MILO_LOCATION__', LOC);
...
(function () {
  ...
  fetch(GH + '/v3/pages/science.html?v=5').then(function (r) {
    if (!r.ok) throw new Error('HTTP ' + r.status);
    return r.text();
  }).then(function (html) {
    html = html.replace('__MILO_LOCATION__', LOC);
...
(function () {
  ...
  fetch(GH + '/v3/pages/homeowners.html?v=5').then(function (r) {
    if (!r.ok) throw new Error('HTTP ' + r.status);
    return r.text();
  }).then(function (html) {
    html = html.replace('__MILO_LOCATION__', LOC);
...
(function () {
  ...
  fetch(GH + '/v3/pages/builders.html?v=5').then(function (r) {
    if (!r.ok) throw new Error('HTTP ' + r.status);
    return r.text();
  }).then(function (html) {
    html = html.replace('__MILO_LOCATION__', LOC);
...
(function () {
  ...
  fetch(GH + '/v3/pages/locations.html?v=5').then(function (r) {
    if (!r.ok) throw new Error('HTTP ' + r.status);
    return r.text();
  }).then(function (html) {
    html = html.replace('__MILO_LOCATION__', LOC);
...
(function () {
  ...
  fetch(GH + '/v3/pages/form.html?v=5').then(function (r) {
    if (!r.ok) throw new Error('HTTP ' + r.status);
    return r.text();
  }).then(function (html) {
    html = html.replace('__MILO_LOCATION__', LOC);
